CREATE TABLE tbl_user (
	...
	INSERT INTO tbl_user (matricula, nome, password, profile, coordenacao ) values 
		('cC' , 'Araujo Cavalcante' , '$2a$10$O0NBXCVx38/3hMWs5E4H.uKu.A1bZq2xx4ll937Dk37RjRChKUTnS', 'ROLE_CUSTOMER', 'SIRFG');		
		
	INSERT INTO tbl_user (matricula, nome, password, profile, coordenacao ) values 
		('cT' , 'Edson Violino' , '$2a$10$O0NBXCVx38/3hMWs5E4H.uKu.A1bZq2xx4ll937Dk37RjRChKUTnS', 'ROLE_TECHNICIAN', 'SIFAG');		
